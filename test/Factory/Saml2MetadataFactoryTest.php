...
class Saml2MetadataFactoryTest extends AbstractHttpControllerTestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->services->setFactory('MehrAlsNix\ZF\SAML\Service\SAML2Metadata', 'MehrAlsNix\ZF\SAML\Factory\Saml2MetadataFactory');
        // @codingStandardsIgnoreEnd
        $this->factory = new Saml2MetadataFactory();
    }
